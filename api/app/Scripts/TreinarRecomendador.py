...
def Main() -> None:
    ...
    with CriarSessao() as sessao:
        ...
        caminho = RecomendacaoService.SalvarModelo(
            modelo, Configuracao.GetDiretorioArtefatosAbsoluto()
        )
        ...
        if argumentos.persistir:
            ...
            inicio = perf_counter()
            total = RecomendacaoService.PersistirSimilares(
                sessao, modelo, argumentos.top_n, argumentos.bloco
            )
